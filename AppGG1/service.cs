    ...
    public partial class service : UserControl
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "insert into service values(" + int.Parse(bunifuMaterialTextbox1.Text) + ",'" + bunifuMaterialTextbox2.Text + "')";
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from service where codeService ='" + bunifuMaterialTextbox1.Text + "'";
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = cnx;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update service set nom='" + bunifuMaterialTextbox2.Text + "' where codeService=" + id;
                cmd.ExecuteNonQuery();
            ...
            if (id != 0)
            {
                ...
                if (d == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        cmd.CommandText = "delete from service where codeService='" + id.ToString() + "'";
                ...
                {
                    MessageBox.Show("Merci de selctioner un Service");
                }
            }
        }
        ...
        {
            string req = "select * from service where concat(codeService,nom) like '%" + valueToSearch + "%'";
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialoge.FileName = "outputService";
