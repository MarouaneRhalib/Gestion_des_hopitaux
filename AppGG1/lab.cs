    ...
    public partial class lab : UserControl
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "insert into laboratoire values(" + int.Parse(bunifuMaterialTextbox1.Text) + "," + int.Parse(bunifuMaterialTextbox2.Text) + ",'" + bunifuMaterialTextbox3.Text + "')";

                cmd.ExecuteNonQuery();
                MessageBox.Show("ajout effectué");
                //Laboratoire_Load(sender, e);
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from laboratoire where codelaboratoire ='" + bunifuMaterialTextbox1.Text + "'";
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = cnx;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update laboratoire set codeHopital=" + int.Parse(bunifuMaterialTextbox2.Text) + ",nom='" + bunifuMaterialTextbox3.Text + "' where codeLaboratoire=" + id;
                cmd.ExecuteNonQuery();
            ...
            if (id != 0)
            {
                ...
                if (d == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        cmd.CommandText = "delete from laboratoire where codelaboratoire='" + id.ToString() + "'";
                ...
                {
                    MessageBox.Show("selctioner un Laboratoire");
                }
            }
        }
        ...
        {
            string req = "select * from laboratoire where concat(codeLaboratoire,codeHopital,nom ) like '%" + valueToSearch + "%'";
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialoge.FileName = "outputLaboratoire";
